...
func (r *UserRepo) Create(ctx context.Context, u *domain.User) error {
	const q = `
INSERT INTO users (id, email, display_name, avatar_url, country, language, created_at, updated_at)
...
func (r *UserRepo) GetByID(ctx context.Context, id string) (*domain.User, error) {
	const q = `
SELECT id, email, display_name, avatar_url, country, language, created_at, updated_at
...
SET display_name = $2,
    ...
    updated_at   = $6
WHERE id = $1
RETURNING id, email, display_name, avatar_url, country, language, created_at, updated_at`
	u := &domain.User{}
